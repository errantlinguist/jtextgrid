...
public class NamedTierFactory<D> extends BasicMutableChild<TextGridFile<D>>
	...
	/**
	 * The end time of the next new {@link NamedTier} object.
	 */
	...
	/**
	 * The size of the next new {@link NamedTier} object measured by the number
	 * of entries it has.
	 */
	private int size = NULL_VALUE;

	/**
	 * The start time of the next new {@link NamedTier} object.
	 */
	private double startTime = NULL_VALUE;

	/**
	 * The tier class of the next new {@link NamedTier} object.
	 */
	 ...
	 * 
	 * @param index
	 *            The index of the next new {@link NamedTier} object.
	 */
